    ...
    <div class="row">
        <div class="col-12">
            <div class="d-flex justify-content-between align-items-center mb-4">
                <h1><i class="fas fa-plus"></i> Create Quote</h1>
                                            ...
                                            <div class="quote-item border rounded p-3 mb-3">
                                                <div class="row">
                                                    ...
                                                    <div class="col-3">
                                                        <label class="form-label">Unit Price *</label>
                                                        <input type="number" class="form-control item-price" 
                                                               name="items[0][unit_price]" value="0" 
                                                               min="0" step="0.01" required>
                                                    </div>
                                                    <div class="col-3">
                                                        <label class="form-label">Tax Rate (%)</label>
                                                        <input type="number" class="form-control item-tax" 
                                                               name="items[0][tax_rate]" value="0" 
                                                               min="0" max="100" step="0.01">
                                                    </div>
                                                    <div class="col-2 d-flex align-items-end">
                                                        <button type="button" class="btn btn-outline-danger btn-sm remove-item w-100" disabled>
                                                            <i class="fas fa-trash"></i>
                                                        </button>
                                                    </div>
                                                    <div class="col-12 mt-2">
                                    ...
                                    <div class="col-md-6">
                                        <div class="mb-3">
                                            ...
                                            <textarea class="form-control" id="terms" name="terms" rows="4" 
                                                      placeholder="Enter terms and conditions...">{{ old('terms') }}</textarea>
                                        </div>
                                    </div>
                                    <div class="col-md-6">
                                        <div class="mb-3">
