    ...
    <div class="row">
        <div class="col-12">
            <div class="d-flex justify-content-between align-items-center mb-4">
                <h1><i class="fas fa-plus"></i> Create Supplier</h1>
                ...
                <div class="row">
                    ...
                    <div class="col-lg-4">
                        <div class="card">
                            ...
                            <div class="card-body">
                                <p class="text-muted">
                                    Create a new supplier to track expenses and manage vendor relationships.
                                </p>
                                
                                <div class="alert alert-info">
                                    <i class="fas fa-info-circle"></i>
                                    <strong>Tip:</strong> Suppliers with tax numbers are considered business suppliers.
                                </div>
