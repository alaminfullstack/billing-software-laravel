    ...
    <div class="row">
        <div class="col-12">
            <div class="d-flex justify-content-between align-items-center mb-4">
                <h1><i class="fas fa-plus"></i> Create Tax Rate</h1>
                        ...
                        <div class="card">
                            ...
                            <div class="card-body">
                                <div class="text-center">
                                    <h2 class="text-primary" id="preview-rate">0%</h2>
                                    <p class="text-muted mb-0" id="preview-type">Percentage</p>
                                </div>
                                
                                <hr>
                                
                                <h6>Usage Examples:</h6>
                                <div id="percentage-examples" class="mt-3" style="display: none;">
                                    <div class="example-calculation mb-2">
                                        <small class="text-muted">On $100.00:</small><br>
                                        <strong id="example-amount">$0.00</strong>
                                    </div>
                                </div>
                                
                                <div id="fixed-examples" class="mt-3" style="display: none;">
                                    <div class="example-calculation mb-2">
                                        <small class="text-muted">Any amount:</small><br>
                                        <strong id="fixed-amount">$0.00</strong>
                                    </div>
                                </div>
                            </div>
                        </div>
