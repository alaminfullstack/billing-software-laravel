                                    ...
                                    <div class="col-md-4">
                                        <div class="mb-3">
                                            ...
                                            <select class="form-select @error('rate_type') is-invalid @enderror" 
                                                ...
                                                <option value="hourly" {{ old('rate_type') == 'hourly' ? 'selected' : '' }}>Hourly Rate</option>
                                                <option value="daily" {{ old('rate_type') == 'daily' ? 'selected' : '' }}>Daily Rate</option>
                                                <option value="project" {{ old('rate_type') == 'project' ? 'selected' : '' }}>Per Project</option>
                                                <option value="package" {{ old('rate_type') == 'package' ? 'selected' : '' }}>Package Deal</option>
                                            </select>
                                            @error('rate_type')
                                                <div class="invalid-feedback">{{ $message }}</div>
                                            @enderror
                                    ...
                                    <div class="col-md-6">
                                        <div class="mb-3">
                                            ...
                                            <textarea class="form-control @error('requirements') is-invalid @enderror" 
                                                      ...
                                                      placeholder="What do you need from the client?">{{ old('requirements') }}</textarea>
                                            @error('requirements')
                                                <div class="invalid-feedback">{{ $message }}</div>
                                            @enderror
                                        </div>
                                    ...
                                    <div class="col-12">
                                        <div class="mb-3">
                                            ...
                                            <textarea class="form-control @error('features') is-invalid @enderror" 
                                                      ...
                                                      placeholder="List what's included in this service...">{{ old('features') }}</textarea>
                            ...
                            <div class="card-body">
                                ...
                                <div class="form-check mb-3">
                                    <input class="form-check-input" type="checkbox" id="allow_customization" 
                                           name="allow_customization" value="1" {{ old('allow_customization', true) ? 'checked' : '' }}>
                                ...
                                <div class="form-check mb-3">
                                    <input class="form-check-input" type="checkbox" id="requires_deposit" 
                                           name="requires_deposit" value="1" {{ old('requires_deposit') ? 'checked' : '' }}>
                                ...
                                <div class="mb-3">
                                    ...
                                    <div class="input-group">
                                        <input type="number" class="form-control @error('deposit_percentage') is-invalid @enderror" 
                                               ...
                                               value="{{ old('deposit_percentage', 0) }}" min="0" max="100" step="1">
                                        <span class="input-group-text">%</span>
                                    </div>
                            ...
                            <div class="card-body">
                                <div class="form-check mb-3">
                                    <input class="form-check-input" type="checkbox" id="requires_appointment" 
                                           name="requires_appointment" value="1" {{ old('requires_appointment') ? 'checked' : '' }}>
                                ...
                                <div class="form-check mb-3">
                                    <input class="form-check-input" type="checkbox" id="has_revisions" 
                                           name="has_revisions" value="1" {{ old('has_revisions', true) ? 'checked' : '' }}>
                                ...
                                <div class="mb-3">
                                    ...
                                    <input type="number" class="form-control @error('max_revisions') is-invalid @enderror" 
                                           ...
                                           value="{{ old('max_revisions', 2) }}" min="0">
